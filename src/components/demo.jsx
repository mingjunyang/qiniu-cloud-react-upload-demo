...
import {ReactQiniu as Dropzone} from './upload.jsx';

export let ReactQiniuExample = React.createClass({
  getInitialState() {
    return {files: [], token: 'YOUR_UPLOAD_TOKEN', uploadKey: 'YOUR_CUSTOM_UPLOAD_KEY', prefix: 'YOUR_QINIU_KEY_PREFIX'};
  },
      ...
      <div className='dropped-files' style={styles}>
        ...
        <ul>
          {[].map.call(files, function(f, i) {
            ...
            return <li key={i}>{preview} {f.name + ' : ' + f.size / 1000 + 'KB.'}
  ...
  render() {
    ...
    return (
      <div className="react-qiniu-example">
        <Dropzone onDrop={this.onDrop} onUpload={this.onUpload} size={300} token={this.state.token} accept="image/*" style={dropZoneStyles}>
          <div style={styles}>
